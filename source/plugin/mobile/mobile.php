...
$modules = array('extends', 'buyattachment', 'buythread', 'checkpost', 'connect',
	...
	// @oxyflour: to support adding comments
...
$_GET['version'] = !empty($_GET['version']) ? intval($_GET['version']) : (isset($defaultversions[$_GET['module']]) ? $defaultversions[$_GET['module']] : 1);
